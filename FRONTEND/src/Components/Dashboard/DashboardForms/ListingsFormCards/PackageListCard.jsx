...
const PackageListCard = () => {
  ...
  return (
    <div
      onClick={() => navigate("/dashboard/listings/packages")}
      className="
    ...
    >
      ...
      <h3 className="text-xl font-semibold text-gray-800">Package Lists</h3>
      <p className="text-gray-600 text-sm">View + manage Hajj &amp; Umrah packages</p>
